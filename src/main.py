...
label1 = ttk.Label(root, text='Threshold')
label1.grid(row=1,column=1)
label1.grid_configure(padx=10, pady=15)

var = tk.IntVar(root)
var.set(500)
sp1 = tk.Spinbox(root,textvariable=var,from_=0,to=100000,increment=100)
sp1.grid(row=1,column=2)
sp1.grid_configure(padx=10, pady=15)

label2 = ttk.Label(root, text='Bout')
...
var2.set(0.25)
ary=[0, 0.25, 0.5, 1, 2]
sp2 = tk.Spinbox(root,textvariable=var2,value=ary)
